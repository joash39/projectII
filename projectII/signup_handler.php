...
if(isset($_POST['signup'])){
    ...
    $sql = "SELECT * FROM `registration` WHERE firstname='$firstname' OR email='$email' LIMIT 1";
    ...
    $sql = "INSERT INTO `registration`(`id`, `firstname`, `lastname`, `email`, `password`) VALUES (null,'$firstname','$lastname','$email','$password_1')";
